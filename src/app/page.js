...
- Required Documents: Lenders may ask for identity proof, address proof, income proof, and bank statements.`,
  ...
  return (
    ...
    > */}
      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-end pt-[100px] lg:pt-[200px] pb-[100px] lg:pb-[200px] relative z-10">
        ...
        <section className="w-full bg-green-900 py-24 px-4 my-12 ">
          <div className="container mx-auto flex flex-col lg:flex-row items-center lg:items-center justify-between">

            {/* Left Text */}
            <div className="lg:w-1/2 text-center lg:text-left text-white">
              <h1 className="text-3xl sm:text-4xl flex justify-center md:text-5xl font-semibold leading-snug">
                Compare loans <br />
                from several <br />
                banks and find <br />
                the best offer!
              ...
              <div className="mt-8 mx-32">
                <Link
                  href="/apply"
                  className="inline-block  px-8 py-4 rounded-full bg-white text-green-900 font-semibold hover:bg-green-200 transition-colors text-lg"
                >
                  Apply Now
                </Link>
              </div>
        ...
        <section className="py-16 bg-white shadow-md dark:bg-black animate-slide-right delay-300">
  ...
  `}</style>
        ...
        >
          <div className="container  mx-auto">
            <motion.div
              className="max-w-6xl mx-auto bg-white/90 backdrop-blur-md shadow-lg hover:shadow-xl rounded-2xl p-10 text-center border border-green-200"
