...
- Required Documents: Lenders may ask for identity proof, address proof, income proof, and bank statements.`,
  ...
  return (
    ...
    > */}
      ...
      <section className="relative w-full min-h-[500px] sm:min-h-[600px] lg:min-h-screen pt-[90px] lg:pt-[150px] overflow-hidden my-24 bg-gradient-to-r from-green-900 to-green-900  ">
