                ...
                <div className="container mx-auto px-4">
                    <div className="description-widget">
                        <div className="max-w-4xl mx-auto">
                            <div className="desc-text lg:pl-10 space-y-6 text-gray-600">

                                <p>
                                    <strong>1. Introduction</strong>
                                    <br />
                                    Secure Edge Solution (&quot;Company,&quot; &quot;we,&quot; &quot;our,&quot; or &quot;us&quot;)
                                </p>

                                <p>
                                    <strong>2. Information We Collect</strong>
                                    <br />
                                    When you apply for a bank loan through Secure Edge Solution, we may collect the following types of information:
                                </p>
                                ...
                                <ul className="list-disc list-inside space-y-2">
                                    <li>
                                        <strong>Financial Institutions & Lenders:</strong> To facilitate loan approval and processing.
                                    </li>
                                    <li>
                                        <strong>Regulatory Authorities:</strong> If required by law or legal processes.
                                    </li>
                                    <li>
                                        <strong>Third-Party Service Providers:</strong> For fraud prevention, credit analysis, or customer support.
                                    </li>
                                </ul>
                                ...
                                <p>
                                    <strong>7. Cookies & Tracking Technologies</strong>
                                    <br />
                                ...
                                <p>
                                    ...
                                    <br />
                                    Website: <Link href="https://secureedgesolution.com/" className="text-blue-600 hover:underline">
