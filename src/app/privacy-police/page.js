      ...
      <div className="flex flex-col">
        <div className="desc-text lg:pl-10 text-gray-700 leading-relaxed">
          <p className="mb-6">
            ...
            <br />
            The Loan Compass (&quot;Company,&quot; &quot;we,&quot;
            &quot;our,&quot; or &quot;us&quot;) values your privacy and
            is committed to protecting your personal information. This
            Privacy Policy outlines how we collect, use, and safeguard
            the information you provide when applying for a bank loan
          ...
          <p className="mb-6">
            ...
            <br />
            When you apply for a bank loan through The Loan Compass, we
            may collect the following types of information:
          </p>

          <ul className="list-disc list-inside space-y-2 mb-6">
            <li>
              <strong>Personal Information:</strong> Name, address, date
              of birth, phone number, email address, and
              government-issued identification details.
            </li>
            <li>
              <strong>Financial Information:</strong> Income details,
              credit score, bank account details, employment status, and
              loan history.
            </li>
            <li>
              <strong>Other Information:</strong> IP address, browsing
              behavior, and other relevant data for security and
              analytics.
            </li>
          </ul>
          ...
          <ul className="list-disc list-inside space-y-2 mb-6">
            <li>
              <strong>Financial Institutions &amp; Lenders:</strong> To
              facilitate loan approval and processing.
            </li>
            <li>
              <strong>Regulatory Authorities:</strong> If required by
          ...
          <p className="mb-6">
            ...
            your personal and financial data from unauthorized access,
            disclosure, or loss. However, no method of transmission over
          ...
          <p className="mb-6">
            ...
            <br />
            We use cookies and similar technologies to improve our
            website functionality and enhance user experience. You can
