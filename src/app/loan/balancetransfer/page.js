          ...
          <div className="lg:w-2/3 w-full flex flex-col gap-4">
            ...
            <div className="text-gray-500 space-y-3">
              ...
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>
                  🔄 <strong>Consolidate Debt</strong> – Combine multiple loans or credit card balances into one easy payment                </li>
                <li>
                  📅 <strong>Flexible Repayment Terms</strong> – Choose a loan term that suits your financial situation
                </li>
                <li>
                  ⚡ <strong>Quick and Easy Process</strong> – Fast approval with minimal paperwork                </li>
                <li>
                  🔒 <strong>No Collateral Needed</strong> – Secure the loan without putting assets at risk                </li>
