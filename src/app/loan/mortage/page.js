            ...
            <section className="py-[135px] my-[-100]">
                <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center lg:items-start gap-8">
                    ...
                    <div className="lg:w-2/3 w-full flex flex-col gap-4">
                        <button className=" text-black text-start px-4 py-1 mb-2">
                            Mortgage Loan
                        </button>
                        ...
                        <div className="text-gray-700 space-y-3">
                            ...
                            <ul className="list-disc list-inside space-y-1">
                                <li>🛖 <strong>Low Interest Rates</strong> – Affordable EMIs to fit your budget</li>
                                <li>📆 <strong>Flexible Tenure Options</strong> – Choose repayment terms as per your convenience</li>
                                <li>⚡ <strong>Quick Approvals</strong> – Fast processing for hassle-free disbursal</li>
                                <li>📑 <strong>Minimal Documentation</strong> – Simple and easy paperwork to save time</li>
                                <li>🏗️ <strong>Loans for All Needs</strong> – Buy a property, construct, renovate, or expand</li>
                            </ul>
                        ...
                        <a
                            href="https://secureedgesolution.com/contact"
                            className="inline-block bg-blue-800 text-white rounded-full px-6 py-2 mt-4 hover:bg-blue-900 transition"
                        >
                            Apply
                        </a>
                    </div>
