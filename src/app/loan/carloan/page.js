                        ...
                        <div className="md:col-span-8 my-[-70]">
                            <div className="services-content">
                                ...
                                <p className="text-gray-500 mb-4">
                                    ...
                                    home your desired car. Whether you're looking to buy a{" "}
                                    <strong>new car</strong> or a <strong>used one</strong>, we
                                    provide a hassle-free process with{" "}
                                    <strong>minimal documentation</strong> and{" "}
