 ...
 function HomeLoanSection() {
  ...
  return (
    <div>
      {/* Header Section */}
      <motion.section
        className="relative w-full bg-gradient-to-r from-green-900 to-green-900 min-h-[25vh] flex items-center justify-center my-24"
        initial="hidden"
        animate="show"
        variants={container}
      >
        <div className="absolute inset-0 bg-black/10"></div>
        <motion.div className="relative z-10 text-center px-4" variants={slideRight}>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white drop-shadow-lg">
            Home Loan
          </h1>
        </motion.div>
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 mx-4 sm:mx-6 lg:mx-8 flex flex-col lg:flex-row items-center lg:items-start gap-8">
          {/* Left Image */}
          <motion.div className="lg:w-1/3 w-full" variants={slideRight}>
            <div className="services-img">
              <Image
                src="https://media.istockphoto.com/id/1298816514/photo/sales-executive-stock-photo.webp?a=1&b=1&s=612x612&w=0&k=20&c=ahM79sCLCHez0TGAOnoNMfphU6NKWxTT9Wt-b5xVwDQ="
                alt="Service Image"
          ...
          {/* Right Content */}
          <motion.div className="lg:w-2/3 w-full flex flex-col gap-4" variants={slideRight}>
            <button className="text-green-900 font-bold text-start px-4 py-1 mb-2">
              Home Loan
            </button>
