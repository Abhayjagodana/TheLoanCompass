        ...
        >
          ...
          <div className="text-gray-500 space-y-3">
            ...
            <p className="text-green-900">
              💼 <strong>Why Choose Our Unsecured Business Loans?</strong>
            </p>
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>
                📅 <strong>Flexible Repayment Plans</strong> – Customize terms to fit cash flow
              </li>
              <li>
              ...
              <li>
                🛠️ <strong>Multiple Business Uses</strong> – Invest in tech, inventory, staffing, or marketing
              </li>
            </ul>
