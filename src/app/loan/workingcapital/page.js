                ...
                <div className="lg:w-2/3 w-full flex flex-col gap-4">
                    ...
                    <div className="text-gray-500 space-y-3">
                        ...
                        <ul className="list-disc list-inside space-y-1">
                            <li>
                                💸 <strong>Quick Approval and Disbursal</strong> – Get funds within days, not
                                weeks
                            </li>
                            <li>
                                🔒 <strong>No Collateral Needed</strong> – Keep your assets safe
                            </li>
                            <li>
                                📅 <strong>Flexible Repayment Plans</strong> – Tailor repayment to your cash
                                flow
                            </li>
                            <li>
                                📄 <strong>Minimal Documentation</strong> – Fast and simple process
                            </li>
                            <li>
                                ⚡ <strong>Short-Term Loan</strong> – Perfect for immediate expenses
                            </li>
                            <li>
                                🔑 <strong>Boost Your Cash Flow</strong> – Keep operations running smoothly
                            </li>
                        </ul>
